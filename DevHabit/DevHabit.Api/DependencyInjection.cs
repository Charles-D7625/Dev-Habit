...
public static class DependencyInjection
{
    public static WebApplicationBuilder AddApiServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.Configure<MvcOptions>(options =>
        {
            ...
            formatters.SupportedMediaTypes.Add(CustomMediaTypeNames.Application.JsonV2);
            formatters.SupportedMediaTypes.Add(CustomMediaTypeNames.Application.HateoasJson);
            formatters.SupportedMediaTypes.Add(CustomMediaTypeNames.Application.HateoasJsonV1);
            formatters.SupportedMediaTypes.Add(CustomMediaTypeNames.Application.HateoasJsonV2);
        });
