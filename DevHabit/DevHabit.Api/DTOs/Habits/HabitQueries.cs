...
internal static class HabitQueries
{
    ...
    public static Expression<Func<Habit, HabitWithTagsDto>> ProjectToHabitWithTagsToDto()
    {
    ...
    public static Expression<Func<Habit, HabitWithTagsDtoV2>> ProjectToHabitWithTagsToDtoV2()
    {
